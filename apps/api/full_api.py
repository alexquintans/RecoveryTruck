...
try:
    from routers import auth, tickets, services, payment_sessions, websocket, operation
    ...
    if "operation" not in loaded_routers:
        loaded_routers["operation"] = operation.router
