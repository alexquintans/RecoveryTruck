        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              placeholder="Preço (R$) *"
              className={`w-full rounded-lg border-2 px-4 py-2 transition-all focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6] bg-white text-[#1F526B] text-base ${touched.price && form.price < 0 ? 'border-red-500' : 'border-gray-300'}`}
            />
            <input
              type="number"
              value={form.stock}
              ...
              placeholder="Estoque *"
              className={`w-full rounded-lg border-2 px-4 py-2 transition-all focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6] bg-white text-[#1F526B] text-base ${touched.stock && form.stock < 0 ? 'border-red-500' : 'border-gray-300'}`}
            />
          </div>
          <input
            value={form.category}
            ...
            className={`w-full rounded-lg border-2 px-4 py-2 transition-all focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6] bg-white text-[#1F526B] text-base ${touched.category && !form.category ? 'border-red-500' : 'border-gray-300'}`}
          />
        </div>
